...
const list: ITableRowData[] = [
    { id: '1', url: '1', method: 'GET', type: 'regex' },
    { id: '2', url: '2', method: 'ANY', type: 'normal' },
    { id: '3', url: '3', method: "PATCH", type: 'normal' },
    { id: '4', url: '4', method: "DELETE", type: 'normal' },
    { id: '4', url: '4', method: "PUT", type: 'normal' },
    { id: '4', url: '4', method: "POST", type: 'normal' },
]
...
const RowContainer = defineComponent({
    ...
    setup(props) {
        ...
        // 设置type
        const setType = () => {
            props.data.type = props.data.type === 'normal' ? 'regex' : 'normal'
        }
        return () =>
            <>
                <div class={styl.row}>
                    ...
                    <div class={styl.rowInput}>
                        <NInput size="small" placeholder="url">
                            {{
                                suffix: <NIcon size={20} class={[styl.regexIcon, props.data.type === 'regex' ? styl.regexActive : '']}>
